    ...
    <>
      <div className="flex justify-center items-start min-h-screen">
        ...
        <div className="flex-1 max-w-5xl p-16">
          <div className="grid grid-cols-5 grid-rows-1 gap-4 grid-flow-row-dense">
            <div className="p-4 pr-6 bg-white dark:bg-slate-700 border-1-8 border-transparent rounded-md shadow-md space-y-2 flex flex-col items-center">
              <h6 className="text-7xl font-semibold">
                {hiragana[0][0].hiragana}
              </h6>
              <p className="uppercase">{hiragana[0][0].romanji}</p>
            </div>
            <div className="p-4 pr-6 bg-white dark:bg-slate-700 border-1-8 border-transparent rounded-md shadow-md space-y-2 flex flex-col items-center">
              <h6 className="text-7xl font-semibold">A</h6>
